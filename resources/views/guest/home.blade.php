                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="{{url('/login')}}" method="POST">
                            <div class="text-center">
                                {{--<img src="{{url('assets/images/auth/logo-dark.png')}}" alt="logo">--}}
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><b>Rumah Data Team</b></p>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{{url('assets/images/auth/Logo-small-bottom.png')}}"
                                            alt="Rumah Data (Arsip)">
                                    </div>
                                </div>
